...
final class LiveCache[F[_]: Async: Functor] private (state: Cache2kCache[Rate]) extends Cache[F] {
...
object LiveCache {
  ...
  def of[F[_]: Async](expires: FiniteDuration): Cache[F] = {
    ...
    new LiveCache[F](customisedCache2kCache)
  }
}
